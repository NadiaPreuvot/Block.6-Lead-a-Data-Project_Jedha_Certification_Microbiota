...
def main():
    ...
    if choix == "Documentation":
        st.subheader("Provenance des datasets:")

        st.write("Les datasets proviennent d'un projet Kaggle (https://www.kaggle.com/datasets/cameronmacpherson/ml-course-ku-3927220000-p003)")

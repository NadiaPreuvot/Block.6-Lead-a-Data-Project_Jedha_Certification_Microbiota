...
if 'data' in st.session_state:
    ...
    st.write("Les pavés colorés représentent, dans l'ordre décroissant, la quantité moyenne pour chaque bactérie pour chaque statut de santé et pour chaque pays.")